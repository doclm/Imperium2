...
public class Imperium {
     ...
     */
    public static Imperium get() {
        Imperium aImperium = mLocalInst.get();
    ...
    private static Imperium create() {
        ...
        Empire aEmpire = Empire.get().instance(Empire.class);

        Imperium aImperium = new Imperium(aEmpire);

        mLocalInst.set(aImperium);
    ...
    private EntityManager getEntityManager() {
        if (mEntityManager == null) {
            mEntityManager = Persistence.createEntityManagerFactory("SDB2").createEntityManager();
        }
